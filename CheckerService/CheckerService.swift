...
protocol CheckerServiceProtocol {
    ...
    func checkCredentials(for email: String, and password: String, completion: @escaping ((Result<User,Error>) -> Void))
    
    func signUp(for email: String, and password: String,completion: @escaping ((Result<User,Error>) -> Void))
